...
export default function QuranTranslationLandingPage() {
  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_20%,rgba(247,183,24,0.10),transparent_22%),radial-gradient(circle_at_82%_18%,rgba(0,95,86,0.14),transparent_24%),radial-gradient(circle_at_50%_55%,rgba(247,183,24,0.06),transparent_28%),radial-gradient(circle_at_48%_72%,rgba(0,95,86,0.10),transparent_30%),linear-gradient(135deg,#17060D_0%,#26101A_18%,#33202A_34%,#213232_52%,#153F3B_70%,#0C2A28_86%,#081A19_100%)]" />
          ...
          <section className="relative grid min-h-[auto] items-center gap-10 py-10 sm:gap-12 sm:py-14 lg:min-h-[84vh] lg:grid-cols-[1.05fr_0.95fr] lg:py-20">
            <div className="order-1 lg:order-1">
              ...
              <motion.h1
                ...
                animate="show"
                variants={fadeUp}
                className="overflow-visible text-3xl font-black leading-[1.4] sm:text-5xl lg:text-7xl"
              >
                <span className="block px-1 pb-[0.18em] pt-[0.12em] bg-gradient-to-l from-[#F7B718] via-[#FFD978] to-[#DF7500] bg-clip-text text-transparent [text-wrap:balance]">
                  සනා කුරානි නාලිකා
                </span>
              </motion.h1>
